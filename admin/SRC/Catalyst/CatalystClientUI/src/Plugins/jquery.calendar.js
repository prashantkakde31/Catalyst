            ...
            if (_dragdata) {
                ...
                switch (d.type) {
                    case 1: //day view
                        ...
                        //Commented quick add popup and added edit details code to invoke Eddit Popup with start date and time

                        var stTime = dateFormat.call(start, i18n.xgcalendar.dateformat.fulldayvalue + " HH:mm");
                        var etTime = dateFormat.call(end, i18n.xgcalendar.dateformat.fulldayvalue + " HH:mm");
                        ...
                        if (!option.EditCmdhandler) {
                            ...
                            if (option.EditCmdhandler && $.isFunction(option.EditCmdhandler)) {
                                option.EditCmdhandler.call(this, ['0', $("#bbit-cal-what").val(), stTime, etTime, $("#bbit-cal-allday").val()]);
                            }
                            $("#bbit-cal-buddle").css("visibility", "hidden");
                            realsedragevent();
                        }
