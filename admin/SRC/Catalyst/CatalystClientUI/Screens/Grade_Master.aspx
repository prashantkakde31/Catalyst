<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage2.master" AutoEventWireup="true" CodeBehind="Grade_Master.aspx.cs" Inherits="CatalystClientUI.Grade_Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    ...
    <div class="page-header">
        <h1>Admin
		<small><i class="ace-icon fa fa-angle-double-right"></i>Grade Master</small>
        </h1>
    </div>

    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title align-center">Grade Master</h3>
        </div>
        <div class="panel-body">
            <div class="row">
                <div class="form-group col-sm-6 col-md-12">
                    <label class="col-sm-4 control-label text-right">Grade Name</label>
                    <div class="col-sm-4 control-block">
                        <asp:Label runat="server" ID="lblGradeID" Visible="false" Text="-1"></asp:Label>
                ...
                <div class="form-group col-sm-6 col-md-12">
                    <label class="col-sm-4 control-label text-right">Grade Description</label>
                    <div class="col-sm-4 control-block">
                ...
                <div class="form-group col-sm-6 col-md-12">
                    ...
                    <div class="col-sm-2 control-block">
                        <asp:Button runat="server" ID="btnAddGrade" Text="Save" CssClass="btn btn-primary btn-lg btn-block" CausesValidation="true" ValidationGroup="ValidationGroup" OnClick="btnAddCourse_Click" />
                    </div>
                    <div class="col-sm-2 control-block">
            ...
            <asp:GridView runat="server" ID="grdGradeMaster" AutoGenerateColumns="false" CssClass="table table-bordered table-striped dataTable"
                AutoGenerateSelectButton="true" OnSelectedIndexChanging="grdGradeMaster_SelectedIndexChanging" OnRowCommand="grdGradeMaster_RowCommand" AllowPaging="true" PageSize="100" OnPageIndexChanging="grdGradeMaster_PageIndexChanging" ShowHeaderWhenEmpty="true">
                <Columns>
                    <asp:TemplateField HeaderText="Grade ID" Visible="false">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lblID" Text='<%#Eval("GradeID") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Grade Name">
                        <ItemTemplate>
                            <asp:Label ID="lblName" runat="server" Text='<%#Eval("Grade") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            <span onclick="return confirm('Are you sure want to delete?')">
                                <asp:LinkButton ID="btnDelete_Grade" runat="server" CausesValidation="False" CommandName="Delete_Grade"
                                    CommandArgument='<%#Eval("GradeID") %>'>Delete</asp:LinkButton></span>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
